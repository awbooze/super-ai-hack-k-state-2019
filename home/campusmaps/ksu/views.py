...
def handle_uploaded_file(f, b, n):
    ...
    map_rooms(settings.MEDIA_ROOT+"/svg/"+b+"_"+n.__str__()+".svg", "ksu/"+b+"_"+n.__str__()+".txt")
    clean_svg(settings.MEDIA_ROOT+"/svg/"+b+"_"+n.__str__()+".svg",settings.MEDIA_ROOT+"/svg/"+b+"_"+n.__str__()+"c.svg")
